...
import com.boxin.ims.modules.wechat.utils.ZFBUtils;
...
public class Trade extends HttpServlet {
	...
	private Map<String, String> prepareTradeRequestParamsMap(
		...
		// 商品名称
		String subject = request.getParameter("subject");//TradeConfig.SUBJECT;
		// 商品总价
        String totalFee = request.getParameter("tfee");//TradeConfig.TOTAL_FEE;
        
        String userId = request.getParameter("uid");
        // 外部交易号 这里取当前时间，商户可根据自己的情况修改此参数，但保证唯一性
        String outTradeNo = System.currentTimeMillis()+"";
		// 卖家帐号
        Zhifubao zhifubao = ZFBUtils.getZhifubaoByUserId(userId);
		String sellerAccountName = zhifubao.getLoginName(); //PartnerConfig.SELLER;
