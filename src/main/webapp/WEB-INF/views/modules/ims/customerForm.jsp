...
<head>
	...
	<script type="text/javascript">
		$(document).ready(function() {
			...
			$("#inputForm").validate({
				rules: {
					loginName: {remote: "${ctx}/sys/customer/checkLoginName?oldLoginName=" + encodeURIComponent('${customer.name}')}
				},
				messages: {
...
<body>
	...
	<form:form id="inputForm" modelAttribute="customer" action="${ctx}/customer/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="mail" htmlEscape="false" maxlength="100" class="email"/>
			</div>
		</div>
		<div class="control-group">
