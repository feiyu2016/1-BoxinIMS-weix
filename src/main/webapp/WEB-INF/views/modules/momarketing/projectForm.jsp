...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/momarketing/project/">移动营销项目列表</a></li>
	...
	<form:form id="inputForm" modelAttribute="project" action="${ctx}/momarketing/project/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
