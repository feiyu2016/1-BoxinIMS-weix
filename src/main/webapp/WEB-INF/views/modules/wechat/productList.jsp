...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/wechat/product/">产品列表</a></li>
		<shiro:hasPermission name="wechat:product:edit"><li><a href="${ctx}/wechat/product/form">产品添加</a></li></shiro:hasPermission>
	</ul>
	<form:form id="searchForm" modelAttribute="product" action="${ctx}/wechat/product/" method="post" class="breadcrumb form-search">
