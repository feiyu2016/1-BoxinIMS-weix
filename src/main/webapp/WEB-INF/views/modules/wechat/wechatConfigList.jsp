...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/wechat/wechatConfig/">微信上下行数据交互列表</a></li>
		<shiro:hasPermission name="wechat:wechatConfig:edit"><li><a href="${ctx}/wechat/config/form">微信上下行数据交互添加</a></li></shiro:hasPermission>
	</ul>
